package com.example.shixi_a.myapplication.home.work.workTask.process;
...
import com.example.shixi_a.myapplication.home.work.workTask.processAddEdit.ProcessAddEditActivity;
import com.example.shixi_a.myapplication.home.work.workTask.processAddEdit.ProcessAddEditFragment;
import com.example.shixi_a.myapplication.home.work.workTask.processDetail.ProcessDetailActivity;
...
public class ProcessFragment extends Fragment implements ProcessContract.View {
    ...
    @Override
    public void showDetailProcess(Process clickedProcess) {
        Intent intent = new Intent(getActivity(),ProcessDetailActivity.class);
        Bundle bundle = new Bundle();
        bundle.putSerializable("DETAIL_PROCESS",clickedProcess);
        intent.putExtras(bundle);
        startActivity(intent);
    }
    ...
    ProcessFragment.ProcessItemListener mItemListener = new ProcessFragment.ProcessItemListener() {
        ...
        public void onProcessClick(Process clickedProcess) {
            if(getActivity().getIntent().hasExtra("refuse")) {
                ...
                mPresenter.showProcessDetail(clickedProcess);
            }
        }
