package com.example.shixi_a.myapplication.tripReimburseDetail;
...
public class TripReimburseDetailPresenter implements TripReimburseDetailContract.Presenter {

    private String reimburseId;
    private ReimbursementRepository mRepository;
    private TripReimburseDetailFragment mReimburseView;
    private Context context;
    private Reimbursement reimbursement;

    public TripReimburseDetailPresenter(String id, ReimbursementRepository repository, TripReimburseDetailFragment detailFragment, Context context) {
        reimburseId = id;
    ...
    private void proccess(Reimbursement reimbursement) {
        mReimburseView.InitView(
                ...
                reimbursement.getSum_month(), reimbursement.getAddr(),
                reimbursement.getOutcity_traffic_show(), reimbursement.getIncity_traffic_fee(),
                reimbursement.getOutcity_traffic_fee(), reimbursement.getBoarding_fee(),
