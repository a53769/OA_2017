...
import com.example.shixi_a.myapplication.home.work.workAdministration.cashierAudit.CashierAuditActivity;
...
import com.example.shixi_a.myapplication.home.work.workAdministration.financeAudit.FinanceAuditActivity;
import com.example.shixi_a.myapplication.home.work.workAdministration.reimburseLog.ReimburseLogActivity;
...
public class EntertainmentReimburseDetailFragment extends Fragment implements EntertainmentReimburseDetailContract.View {

    private EntertainmentReimburseDetailContract.Presenter mPresenter;
...
//    private TextView end;
    ...
    @Override
    public void setPresenter(EntertainmentReimburseDetailContract.Presenter presenter) {
        mPresenter = presenter;
    }

    public EntertainmentReimburseDetailFragment(){}

    public static EntertainmentReimburseDetailFragment newInstance() {
        return new EntertainmentReimburseDetailFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.entertainment_reimburse_detail_content, container, false);
...
//        end = (TextView) root.findViewById(R.id.end_addr);
        serve_num = (TextView) root.findViewById(R.id.serve_num);
        transport = (TextView) root.findViewById(R.id.transport);
        transport_cost = (TextView) root.findViewById(R.id.transport_cost);
    ...
    @Override
    public void InitView(String status_show, String admin_name, String applicant_name, String type_show, String dttime, String memo, String fee_total, String bill_num, String sum_month, String addr, String incity_traffic_show, String incity_traffic_fee, String serveNum) {
        ...
        transport.setText(incity_traffic_show);
        transport_cost.setText(incity_traffic_fee);
    ...
    @Override
    public void showEntertainmentEdit(Reimbursement reimbursement) {
