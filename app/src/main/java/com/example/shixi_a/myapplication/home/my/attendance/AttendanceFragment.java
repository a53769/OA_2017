package com.example.shixi_a.myapplication.home.my.attendance;
...
import com.example.shixi_a.myapplication.home.my.attendance.leaveList.LeaveListActivity;
...
public class AttendanceFragment extends Fragment implements AttendanceContract.View {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        LinearLayout off_s = (LinearLayout) root.findViewById(R.id.leave);
        off_s.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), LeaveListActivity.class);
                Bundle bundle = new Bundle();
                bundle.putSerializable("attendanceState", attendanceState);
