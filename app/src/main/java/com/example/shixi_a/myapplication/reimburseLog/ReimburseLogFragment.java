package com.example.shixi_a.myapplication.reimburseLog;
...
public class ReimburseLogFragment extends Fragment implements ReimburseLogContract.View {

    private ReimburseLogContract.Presenter mPresenter;
    private LogsAdapter adapter;

    @Override
    public void setPresenter(ReimburseLogContract.Presenter presenter) {
        mPresenter = presenter;
    }

    public ReimburseLogFragment(){}

    public static ReimburseLogFragment newInstance() {
        return new ReimburseLogFragment();
    }
    ...
    public void onCreate(@NonNull Bundle savedInstanceState){
        ...
        adapter = new LogsAdapter(new ArrayList<Reimbursement.Log>(0));
    }
    ...
    @Override
    public void showLogs(List<Reimbursement.Log> logs) {
        adapter.replaceData(logs);
    }

    private static class LogsAdapter extends BaseAdapter {

        List<Reimbursement.Log> mList;

        public LogsAdapter(List<Reimbursement.Log> logs) {
            setList(logs);
        }

        public void setList(List<Reimbursement.Log> list) {
            mList = list;
        }

        public void replaceData(List<Reimbursement.Log> logs) {
            setList(logs);
        ...
        @Override
        public Reimbursement.Log getItem(int position) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            Reimbursement.Log log = getItem(Positon);
