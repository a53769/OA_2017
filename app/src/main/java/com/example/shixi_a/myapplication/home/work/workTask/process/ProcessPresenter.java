...
//            mProcessRepository,refreshProcesses();
    ...
    @Override
    public void selectedProcess(@NonNull Process clickedProcess) {
    ...
    @Override
    public void showProcessDetail(Process clickedProcess) {
        mProcessView.showDetailProcess(clickedProcess);
    }
}
