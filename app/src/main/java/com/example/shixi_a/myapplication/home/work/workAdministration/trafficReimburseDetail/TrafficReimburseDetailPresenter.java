...
public class TrafficReimburseDetailPresenter implements TrafficReimburseDetailContract.Presenter {

    private String reimburseId;
    private ReimbursementRepository mRepository;
    private TrafficReimburseDetailFragment mReimburseView;
    private Context context;
    private Reimbursement reimbursement;

    public TrafficReimburseDetailPresenter(String id, ReimbursementRepository repository, TrafficReimburseDetailFragment detailFragment, Context context) {
        reimburseId = id;
...
//                break;
    ...
    @Override
    public void edit() {
        mReimburseView.showTrafficEdit(reimbursement);
    }
