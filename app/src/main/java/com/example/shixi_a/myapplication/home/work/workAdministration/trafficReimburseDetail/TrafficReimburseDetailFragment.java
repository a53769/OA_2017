package com.example.shixi_a.myapplication.home.work.workAdministration.trafficReimburseDetail;
...
public class TrafficReimburseDetailFragment extends Fragment implements TrafficReimburseDetailContract.View {

    private TrafficReimburseDetailContract.Presenter mPresenter;
...
//    private TextView end;
    ...
    @Override
    public void setPresenter(TrafficReimburseDetailContract.Presenter presenter) {
        mPresenter = presenter;
    }

    public TrafficReimburseDetailFragment(){}

    public static TrafficReimburseDetailFragment newInstance() {
        return new TrafficReimburseDetailFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.traffic_reimburse_detail_content, container, false);
...
//        end = (TextView) root.findViewById(R.id.end_addr);
    ...
    @Override
    public void InitView(String status_show, String admin_name, String applicant_name, String type_show, String dttime, String memo, String fee_total, String bill_num, String sum_month, String addr, String incity_traffic_show, String incity_traffic_fee) {
    ...
    @Override
    public void showTrafficEdit(Reimbursement reimbursement) {
